...
var sUser = new _article2.default();

var User = (_dec = (0, _routerDecorator.reqPath)('/user'), _dec2 = (0, _routerDecorator.get)('/login'), _dec3 = (0, _routerDecorator.post)('/register'), _dec(_class = (_class2 = function () {
  function User() {
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return sUser.login(ctx.request.body);
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return sUser.register(ctx.request.body);
